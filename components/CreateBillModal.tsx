...
const CreateBillModal = ({ visible, onClose, onSubmit }: CreateBillModalProps) => {
        ...
        <Pressable className="modal-overlay" onPress={handleClose}>
          <Pressable className="modal-container" onPress={(e) => e.stopPropagation()}>
            <View className="modal-header">
              <Text className="modal-title">New Bill</Text>
            ...
            >
              ...
              >
                <Text className="auth-button-text">Create Bill</Text>
              </Pressable>
            </ScrollView>
          </Pressable>
        </Pressable>
